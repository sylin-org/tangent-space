...
/// <summary>One typed permission decision over the current effective RoomPolicy.</summary>
...
/// <param name="PolicyRevision">The RoomPolicy revision the decision was evaluated against.</param>
