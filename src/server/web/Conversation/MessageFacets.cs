...
/// <summary>One facet derivation shared by Message persistence, change classification and
/// replay comparison. It reads only stored identities; no provider calls or writes.</summary>
