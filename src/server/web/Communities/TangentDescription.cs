...
public sealed record TangentDescription(string Key, string Name, string Description, string Motto, string Accent, string Artwork,
    string OwnerParticipantId, bool IsOwner, bool CanManage, IReadOnlyList<TopicDescription> Channels, bool ChannelsTruncated = false,
...
public sealed record TangentChannelCreation(TopicAdministrationResult Result, TopicDescription? Channel);
...
public sealed record TangentChannelDirectory(IReadOnlyList<TopicDescription> Channels, int Page, int? NextPage,
