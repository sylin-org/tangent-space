...
public sealed class WindowPlannerTests
{
    ...
    public void Around_window_keeps_anchor_and_contiguous_neighbors()
    {
        ...
        var selected = WindowPlanner.Select(messages, 10, 5);
    ...
    public void Budget_never_skips_a_large_message_to_include_a_later_small_one()
    {
        ...
        var selected = WindowPlanner.Select(messages, 0, 5, 6500);
    ...
    public void Latest_window_keeps_its_newest_message_when_budget_reduces_page()
    {
        ...
        var selected = WindowPlanner.Select(messages, 9, 10);
    ...
    [Fact]
    public void Empty_history_has_no_invented_anchor() => Assert.Empty(WindowPlanner.Select([], 0, 10));
